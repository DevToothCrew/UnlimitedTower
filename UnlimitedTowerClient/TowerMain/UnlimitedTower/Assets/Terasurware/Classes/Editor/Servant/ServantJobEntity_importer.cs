...
public class ServantJobEntity_importer : AssetPostprocessor
{
    private static readonly string filePath = "Assets/Resources/ErdExcels/Servant.xlsx";
    private static readonly string[] sheetNames = { "ServantJobEntity" };
        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
                    ...
                    var data = (ServantJobEntity)AssetDatabase.LoadAssetAtPath(exportPath, typeof(ServantJobEntity));
                    if (data == null)
                    {
					     //�����丮�� ���ٸ� �������ش�
                        ...
                        data = ScriptableObject.CreateInstance<ServantJobEntity>();
                    ...
                    for (int i=2; i<= sheet.LastRowNum; i++)
                    {
                        ...
                        var p = new ServantJobEntity.Param();
