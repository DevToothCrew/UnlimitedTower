...
public class MountItemTeerEntity_importer : AssetPostprocessor
{
    private static readonly string filePath = "Assets/Resources/ErdExcels/Item.xlsx";
    private static readonly string[] sheetNames = { "MountItemTeerEntity" };
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
                    ...
                    if (data == null)
                    {
                        ...
                        data = ScriptableObject.CreateInstance<MountItemTeerEntity>();
                    ...
                    for (int i=2; i<= sheet.LastRowNum; i++)
                    {
                        ...
                        var p = new MountItemTeerEntity.Param();
			
					cell = row.GetCell(0);  if(cell != null) cell.SetCellType(CellType.String); if(cell != null && cell.StringCellValue != "") int.TryParse( cell.StringCellValue, out p.teerNum);
					cell = row.GetCell(1);  if(cell != null) cell.SetCellType(CellType.String); if(cell != null && cell.StringCellValue != "") int.TryParse( cell.StringCellValue, out p.minMountLevel);
