...
public class itemEntity_importer : AssetPostprocessor
{
    private static readonly string filePath = "Assets/Resources/ErdExcels/Characters.xlsx";
    private static readonly string[] sheetNames = { "itemEntity" };
        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
                    ...
                    var data = (itemEntity)AssetDatabase.LoadAssetAtPath(exportPath, typeof(itemEntity));
                    if (data == null)
                    {
					     //�����丮�� ���ٸ� �������ش�
                        ...
                        data = ScriptableObject.CreateInstance<itemEntity>();
                    ...
                    for (int i=2; i<= sheet.LastRowNum; i++)
                    {
                        ...
                        var p = new itemEntity.Param();
			
					cell = row.GetCell(0);  if(cell != null) cell.SetCellType(CellType.String); if(cell != null && cell.StringCellValue != "") int.TryParse( cell.StringCellValue, out p.itemNum);
