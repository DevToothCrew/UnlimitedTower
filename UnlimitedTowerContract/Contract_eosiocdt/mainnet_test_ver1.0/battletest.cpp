...
EOSIO_DISPATCH(battletest,
               ...
               (dbinsert)//(dblistinsert)//(dberase)//(dbinit)                             //     //(setdata)                  //test
               ...
               (setmaster)(eostransfer)(deleteblack)(addblack)(setpause)//(alluserdel)//(allbattle) //(insertequipr)//// //db mastersystem
