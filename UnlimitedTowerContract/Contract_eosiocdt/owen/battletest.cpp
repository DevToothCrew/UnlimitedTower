...
void battletest::etc_item_buy(eosio::name _user, uint32_t _item_id, uint32_t _count)
{
    ...
    for (uint32_t i = 0; i < _count; i++)
    {
        ...
        l_seed = l_seed >> 2;
        gacha_servant_id(_user, l_seed, 0, 1, 3, 3);    //min =1, max= 3 
    }
}
...
EOSIO_DISPATCH(battletest,
                ...
                //(itemchange)(deletetemp)(recorduser)//(setdata)(dbinsert)(insertequipr)(initmaster)(dbinit)(dberase)(dblistinsert)                                                                                                                    
               (transfer)(changetoken)(create)(issue)(leveltest)                                                                                                                        
               (simulate)//(chat)      
               (goldgacha)(dailycheck)                                                                                                                
               (setmaster)(eostransfer)(deleteblack)(addblack)(setpause)
