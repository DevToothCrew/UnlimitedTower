...
class cgacha_system
    ...
    public:
        ...
        {
            uint8_t random_job = safeseed::random_seed(_seed,db_controller.servant_job_count,default_min,servant_random_count++);
        ...
        {   
            uint8_t random_monster_id = safeseed::random_seed(_seed,db_controller.monster_id_count,default_min,monster_random_count++);
            ...
            uint32_t random_rate = safeseed::random_seed(_seed,max_rate,default_min,monster_random_count++);
        ...
        {
            uint8_t random_item_id = safeseed::random_seed(_seed,db_controller.item_id_count,default_min,item_random_count++);
            ...
            uint8_t random_item_tier = safeseed::random_seed(_seed,db_controller.item_tier_count,default_min,item_random_count++);
            ...
            uint8_t random_item_grade = safeseed::random_seed(_seed,db_controller.item_grade_count,default_min,item_random_count++);
            ...
            user_item_table.modify(user_item_list_iter, owner, [&](auto &update_user_item_list) {
                ...
                new_item.i_status.basic_str = safeseed::random_seed(_seed,item_grade_db_iter.i_max_range.i_str,item_grade_db_iter.i_min_range.i_str,item_random_count++);
        ...
        void start_gacha(account_name _user)
        {
            ...
            {
                uint64_t l_gacha_result_type = safeseed::random_seed(l_seed,100000,default_min,0);
